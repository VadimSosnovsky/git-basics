//
//  ViewControllerDogQuestionThird.swift
//  quizApp
//
...
class ViewControllerDogQuestionThird: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "destDogResultVC" {
            if let destVC = segue.destination as? ViewControllerDogResult{
