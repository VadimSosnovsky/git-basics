//
//  ViewControllerCatQuestionThird.swift
//  quizApp
//
...
class ViewControllerCatQuestionThird: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "destCatResultVC" {
            if let destVC = segue.destination as? ViewControllerCatResult {
