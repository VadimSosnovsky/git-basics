//
//  ViewControllerDogQuestionFirst.swift
//  quizApp
//
...
class ViewControllerDogQuestionFirst: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "destDogQuestSecondVC" {
            if let destVC = segue.destination as? ViewControllerDogQuestionSecond{
