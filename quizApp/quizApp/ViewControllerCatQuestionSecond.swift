//
//  ViewControllerCatQuestionSecond.swift
//  quizApp
//
...
class ViewControllerCatQuestionSecond: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "destCatQuestThirdVC" {
            if let destVC = segue.destination as? ViewControllerCatQuestionThird {
